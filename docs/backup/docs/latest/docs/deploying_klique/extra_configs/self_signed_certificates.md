...
to use self-signed or custom Klique Orchestrator. 
...
the `kliqueApplications` section. 
  ...
  basePodTemplate:
    initContainers:
      - command:
        ...
        image: klique/clearml-enterprise-agent-k8s-base:<AGENT-VERSION-AVAILABLE-ON-REPO>
