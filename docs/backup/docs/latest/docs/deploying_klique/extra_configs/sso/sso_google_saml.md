...
1. Set the following environment variables:
   ...
   * `KLIQUE__secure__login__sso__saml_client__google_saml__entity_id=<app_entity_id>`
   * `KLIQUE__secure__login__sso__saml_client__google_saml__idp_metadata_file=<path to the metadata file>` 
   * `KLIQUE__secure__login__sso__saml_client__google_saml__default_company="<company_id>"`
...
apiserver:
  ...
  extraEnvs:
    - name: "KLIQUE__secure__login__sso__saml_client__google_saml__entity_id"
      value: "<app_entity_id>"
    - name: "KLIQUE__secure__login__sso__saml_client__google_saml__idp_metadata_file"
      value: "/opt/clearml/config/default/metadata.xml"
    - name: "KLIQUE__secure__login__sso__saml_client__google_saml__default_company"
      value: "<company_id>"
```
