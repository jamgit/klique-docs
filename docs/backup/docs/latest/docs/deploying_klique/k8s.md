...
the database's lifecycle or version. For MongoDB specifically, Klique disables internal version checks (`KLIQUE__apiserver__mongo__ensure_db_version_on_startup=false`).
