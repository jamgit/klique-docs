...
> The Dataview table for viewing, creating, customizing, and managing Dataviews associated with a project.
...
to the specific task's **DATAVIEWS** tab (see [Tracking Tasks and Visualizing Results](../webapp/webapp_exp_track_visual.md#dataviews)).

View the Dataview table in table view  
or in details view ,
...
You can download the Dataview table as a CSV file by clicking  
...
* In the Dataview table, right-click a Dataview, or hover over a Dataview and click 
