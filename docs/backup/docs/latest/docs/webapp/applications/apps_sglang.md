...
> The SGLang Model Deployment application for serving LLM endpoints, its dashboard, and instance configuration options.
...
* **Queue** - The [Klique Queue](https://clear.ml/docs/latest/docs/fundamentals/agents_and_queues/#what-is-a-queue) to which the SGLang Model Deployment app 
