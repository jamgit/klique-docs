# Dynamic GPU Fractions on Bare Metal and VMs

> Configuring dynamic per-task GPU memory fractions for the ClearML Agent running on bare metal or virtual machines.

Klique Dynamic GPU fractions provide on-the-fly, per task GPU slicing, without having to set up containers or 
...
1. Install the required packages:
   ...
   **Enterprise Packages** **>** **Klique Bare-Metal Dynamic Fractional GPU**. 
   :::
