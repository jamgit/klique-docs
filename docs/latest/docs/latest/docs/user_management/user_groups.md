...
> How administrators create user groups to manage access rules and administrator vaults at the group level.
...
For more information about defining cross-tenant groups on a multi-tenant server deployment, see [Configuring Cross-Tenant Groups](../deploying_klique/multi_tenant_k8s.md#configuring-groups).
