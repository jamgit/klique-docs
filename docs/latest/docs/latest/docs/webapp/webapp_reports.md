...
> Reports for writing notes and findings, embedding live visualizations from Klique objects, and the supported Markdown formatting.

With Reports you can write up notes, task findings, or really anything you want. You can create reports 
...
* Embedded Klique task, model, and [app](applications/apps_overview.md) content
...
Access Reports through the [Reports Page](#reports-page).

## Embedding Visualizations
You can embed plots and images from your Klique objects (tasks, models, and apps) into your reports: scalar 
...
2. Hover over the resource and click . 
   ...
   Click `Embed in report`. This generates the embed code for accessing the resource, and copies 
...
* Your web server's URL (e.g. `app.your-domain.com`)
...
* `objectType` - The type of object to fetch. The options are `task` or `model` (`task` also includes Klique app instances).
...
* `company` - Workspace ID. Applicable for embedding content from a different workspace 
...
The following is a quick reference for the MarkDown syntax that can be used in Reports.
...
|---|-------------------------------------------------------------------------------------------------------------------------------------|
| <code># H1</code><code>## H2</code><code>### H3</code><code>#### H4</code><code>##### H5</code><code>###### H6</code>| ![Report headings](../img/reports_headings.png#light-mode-only) ![Report headings](../img/reports_headings_dark.png#dark-mode-only) |
...
| MarkDown | Rendered Output                                                                                                                                 |
|---|-------------------------------------------------------------------------------------------------------------------------------------------------|
| <code>\> Blockquote\>\> Nested quote 1\>\>\> Nested quote 2</code>| ![Report Blockquotes](../img/reports_blockquotes.png#light-mode-only) ![Report Blockquotes](../img/reports_blockquotes_dark.png#dark-mode-only) |
...
| MarkDown | Rendered Output                                                                                                                                     |
|---|-----------------------------------------------------------------------------------------------------------------------------------------------------|
| <code>1. Item 12. Item 21. Item 31. Item 4</code>| ![Report ordered list](../img/reports_ordered_list.png#light-mode-only) ![Report ordered list](../img/reports_ordered_list_dark.png#dark-mode-only) |
...
| MarkDown | Rendered Output                                                                                                                                             |
|---|-------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <code>+ Item 1+ Item 2&nbsp;&nbsp;- Sub-item a:&nbsp;&nbsp;&nbsp;&nbsp;\* Sub-sub-item x&nbsp;&nbsp;&nbsp;&nbsp;+ Sub-sub-item y&nbsp;&nbsp;&nbsp;&nbsp;- Sub-sub-item z\* [x] A checkmark </code>| ![Report unordered list](../img/reports_unordered_list.png#light-mode-only) ![Report unordered list](../img/reports_unordered_list_dark.png#dark-mode-only) |
...
```
[link with title](https://klique.ai "Klique Documentation")
```

The rendered output should look like this: [link with title](https://klique.ai "Klique Documentation"). Hover over the 
...
| MarkDown | Rendered Output                                                                                                                                                       |
|---|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <code>---___***</code>| ![Reports horizontal rules](../img/reports_horizontal_rules.png#light-mode-only) ![Reports horizontal rules](../img/reports_horizontal_rules_dark.png#dark-mode-only) |
...
```
![Logo](https://klique.ai/docs/latest/img/logo-klique--on-light.svg)
```
...
```
![With title](https://klique.ai/docs/latest/img/logo-klique--on-light.svg "Klique logo")
```
The rendered output should look like this:
