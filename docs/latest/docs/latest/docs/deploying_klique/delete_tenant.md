...
> The step-by-step procedure for deleting a tenant's data from MongoDB, Elasticsearch, and the Fileserver.

The following is a step-by-step guide for deleting tenants (i.e. companies, workspaces) from Klique.

:::tip
Tenants can also be deleted from the Platform Management Center UI. See [Deleting a Tenant](../platform_management_center/pmc_tenants.md#deleting-a-tenant).
:::
