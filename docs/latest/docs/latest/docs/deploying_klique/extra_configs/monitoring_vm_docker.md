# Monitoring (VM / Docker Deployment)

> Recommended practices for monitoring a Klique deployment on AWS VPC or on-premise VM/Docker, covering hardware, service availability, and backups.

The following are general recommendations for monitoring your Klique deployment on AWS VPC or on-prem Ubuntu. These 
